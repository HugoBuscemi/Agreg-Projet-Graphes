...
from random_graph import create_graph, map_color
import sys
import os
import re
...
x11_non_format = """aliceblue 	antiquewhite 	antiquewhite1 	antiquewhite2 	antiquewhite3
...
if __name__ == "__main__" :
    ...
    if os.path.isfile(sys.argv[1]):
        ...
        g = create_graph(n, m)
        colors = map_color(g, n, m)
        name = "rand"
    edges = listEdgesOnes(g)
    filename = name + ".dot"
